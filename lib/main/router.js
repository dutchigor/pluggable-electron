 ...
 * This is required to use any of the Plugin Electron objects in the [renderer API]{@link renderer-API.md}
 * and should be executed right after {@link initPlugins}.
 * @returns {void}
